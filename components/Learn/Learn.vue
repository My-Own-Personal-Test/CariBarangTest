<template>
  <div class="section-learn bg-blue-500 text-white">
    <div class="max-w-2xl mx-auto lg:max-w-7xl py-6 px-3">
      <div class="w-full sm:w-6/12 mx-auto text-center text-white sm:py-6">
        <h1 class="text-xl sm:text-5xl font-bold">
          Apa yang akan kamu pelajari di seminar ini?
        </h1>
        <p
          class="text-white font-bold italic text-base mt-3 sm:text-xl text-center"
        >
      ...
      <div class="py-5 text-center">
        <nuxt-link
          to="/register"
          class="text-white border border-white hover:bg-gray-500 hover:text-white active:bg-gray-600 font-bold capitalize italic text-base px-20 py-3 rounded-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        >
          Register Now
        </nuxt-link>
      </div>
